...
categories:
  - Vue.js 進階心法
source_url: https://ithelp.ithome.com.tw/articles/10273267
---
...
[Mutations | Vuex](https://vuex.vuejs.org/guide/mutations.html) 的開章明義就說，想要改變 state ，就要 over my dead body (透過 mutation)。
...
[Actions | Vuex](https://vuex.vuejs.org/guide/actions.html)
...
[Getters | Vuex](https://vuex.vuejs.org/guide/getters.html#property-style-access)
...
-   後端的 API 可以單純一點，前端依自己的**畫面需求**整理資料。
