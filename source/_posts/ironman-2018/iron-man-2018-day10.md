...
acemnorsuvwxz
```
![](/images/7ed5db06-DdSh5T3.png)

視覺上，圓形略大感覺和方形一樣大。

![](/images/7ed5db06-GMLGIby.png)

所以淘汰有圓形的字母
```
vwxz
```
![](/images/7ed5db06-ms6kA78.png)
...
xz
```
![](/images/7ed5db06-Sq14xIR.png)

比較了各種字型之後，發現一個殘酷的事

![](/images/7ed5db06-STks9lg.png)
