...
<div class="works">
  <div class="webFrontEnd htmlcss">
      ...
      <p>
          ...
          手工特效: Pure CSS Parallax + RWD, Switching page transition<br />
          Animations: Loading page, Navigation bar icon<br />
          工作概述: 初期與案主(設計師)溝通與co-work, 建立合作的溝通模式, 讓案子順利開始, 與設計師溝通使用者情境。製作 baclog 以價值決定工作順序<br />
          中期幫 JavaScript 工程師處理套件的 bug , 確保每個人的工作順利進行。<br />
          掌握案子收尾的 issue tracker, 確保測試結果都有修改, 並順利結案。
      </p>
  </div>
  ...
  <div class="django python exercise webBackEnd">
      ...
      <p>
          原本想說繼續後端, 不要學前端, 挑了一個主流的弱型別語言, 挑了它的後端框架, 挑了一個題目「訂房系統」做練習。<br />
          有做敏捷開發的 End-to-End 的 Story 撰寫練習
      </p>
  </div>
  ...
  <div class="csharp bspline desktopApp">
      ...
      <h4>NURBUS 演用法</h4>
      <p>
          NURBUS、BSpline 都是一種平滑曲線的內插演算法。透過 C# 實現 Windows 繪製曲線。
      </p>
  </div>
  <div class="django python exercise webBackEnd">
      <h2>
  ...
  <div class="casdk cpp mfc desktopApp">
      ...
      <h4>CA-SDK 應用開發</h4>
      <p>
          第二次開發 CA-210 的應用程式。人月神話說的「 第二系統效應」沒有發生。<br />
          軟體產品開發流程、量測規則的核心演算法、運用三角函數。<br />
          UI設計改版, 造成教育訓練成本大幅降低。
      </p>
  </div>
